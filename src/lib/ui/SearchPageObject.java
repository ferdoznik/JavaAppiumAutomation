...
public class SearchPageObject extends MainPageObject
{
    ...
    {
        this.assertElementNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "We were supposed not to find any results");
    }
    ...
    {
        this.assertElementNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "We were supposed to find some results");
    }
}
